...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 275088,
    DYNAMIC_BASE = 5517968,
    DYNAMICTOP_PTR = 274928;
...
var wasmBinaryFile = 'decode_demo.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=274944;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 274992, 4), 274992);function _gmtime_r(time, tmPtr) {
...
var asmGlobalArg = {};
var asmLibraryArg = { "__cxa_allocate_exception": ___cxa_allocate_exception, "__cxa_atexit": ___cxa_atexit, "__cxa_throw": ___cxa_throw, "__lock": ___lock, "__unlock": ___unlock, "abort": _abort, "abs": _abs, "clock": _clock, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "fd_write": _fd_write, "gmtime": _gmtime, "memory": wasmMemory, "setTempRet0": _setTempRet0, "table": wasmTable, "time": _time };
var asm = createWasm();
...
var real__create_buffer = asm["create_buffer"];
asm["create_buffer"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__create_buffer.apply(null, arguments);
};

var real__destroy_buffer = asm["destroy_buffer"];
asm["destroy_buffer"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__destroy_buffer.apply(null, arguments);
};
...
var real__free_result = asm["free_result"];
asm["free_result"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__free_result.apply(null, arguments);
};

var real__get_result_pointer = asm["get_result_pointer"];
asm["get_result_pointer"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__get_result_pointer.apply(null, arguments);
};

var real__get_result_size = asm["get_result_size"];
asm["get_result_size"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__get_result_size.apply(null, arguments);
};

var real__getLicData = asm["getLicData"];
asm["getLicData"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__getLicData.apply(null, arguments);
};

var real__setLicData = asm["setLicData"];
asm["setLicData"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__setLicData.apply(null, arguments);
};

var real__funcodeInit = asm["funcodeInit"];
asm["funcodeInit"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__funcodeInit.apply(null, arguments);
};

var real__FunDecode = asm["FunDecode"];
asm["FunDecode"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__FunDecode.apply(null, arguments);
};

var real__decode = asm["decode"];
asm["decode"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var _getLicData = Module["_getLicData"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["getLicData"].apply(null, arguments)
};

var _setLicData = Module["_setLicData"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["setLicData"].apply(null, arguments)
};

var _funcodeInit = Module["_funcodeInit"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["funcodeInit"].apply(null, arguments)
};

var _FunDecode = Module["_FunDecode"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["FunDecode"].apply(null, arguments)
};
